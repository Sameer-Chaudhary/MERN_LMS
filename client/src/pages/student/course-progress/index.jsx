...
function StudentViewCourseProgressPage() {
  ...
  return (
    <div className="flex flex-col h-screen bg-[#1c1d1f] text-white">
      ...
      <div className="flex items-center justify-between px-6 py-3 bg-[#1c1d1f] border-b border-gray-800">
        <div className="flex items-center gap-4">
          <button
            onClick={() => navigate("/student-courses")}
            className="flex items-center gap-2 px-3 py-1.5 text-sm font-medium text-gray-300 bg-[#2d2f31] rounded-md hover:bg-[#3e4143] transition-colors"
          >
